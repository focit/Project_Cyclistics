...
data = [
    {"gender": "Female", "viajes_customer": 103695, "viajes_subscriber": 599795},
    {"gender": "Male", "viajes_customer": 164712, "viajes_subscriber": 1847245}
]
...
plt.title('El procentaje de clientes Customer que utilizaron Cyclistics según su género en 2019')

# Gráfico de pastel para Subscriber
plt.subplot(1, 2, 2)
plt.pie(viajes_subscriber, labels=genders, autopct='%1.1f%%', startangle=90)
plt.title('El procentaje de clientes Subscriber que utilizaron Cyclistics según su género en 2019')
